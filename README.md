...
[查看 demo](https://sunniejs.cn/lyzh-main-zhoushan-h5/#/) 建议手机端查看
...
git clone https://github.com/sunniejs/lyzh-main-zhoushan-h5.git

cd lyzh-main-zhoushan-h5
...
```html
<img class="image" src="https://cdn.jsdelivr.net/npm/weapp/logo.png" />
...
lyzh-main-zhoushan-h5 所有全局样式都在 `@/src/assets/css` 目录下设置
